...
public class ApplePayFragmentViewModel extends ViewModel {
    ...
    void create() {
        final SpreedlyClient client = SpreedlyClient.newInstance("A54wvT9knP8Sc6ati68epUcq72l", "0f0Cpq17bb5mAAUxtx0QmY2mXyHnEk26uYTrPttn4PIMKZC4zdTJVJSk4YHbe1Ij", true);
        ...
        final String paymentData = "{\n" +
                ...
                "    }\n" +
                "}\n";
        final ApplePayInfo info = new ApplePayInfo(names[0], names[1], paymentData);
